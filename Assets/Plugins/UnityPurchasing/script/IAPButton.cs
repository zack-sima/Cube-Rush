    ...
    public class IAPButton : MonoBehaviour
    {
        ...
        void PurchaseProduct()
        {
            if (buttonType == ButtonType.Purchase)
            {
                ...
                //custom
                CodelessIAPStoreListener.Instance.StoreController.ConfirmPendingPurchase(CodelessIAPStoreListener.Instance.GetProduct(productId));
                Debug.Log("cleared pending purchases");
                //custom
